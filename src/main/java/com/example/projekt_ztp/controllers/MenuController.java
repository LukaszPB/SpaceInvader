...
public class MenuController {
    ...
    protected void newGame() throws IOException {
        ///com/example/projekt_ztp/views/menuView.fxml
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/com/example/projekt_ztp/views/gameView.fxml"));
    ...
    protected void options() throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(Main.class.getResource("/com/example/projekt_ztp/views/settingsView.fxml"));
        Scene scene = new Scene(fxmlLoader.load(), StageProperties.STAGE_WIDTH, StageProperties.STAGE_HEIGHT);
        Stage stage = (Stage) borderPane.getScene().getWindow();
        stage.setScene(scene);
    }
